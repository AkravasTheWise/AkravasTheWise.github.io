...
Thank you for attending my talk. You can access links for the articles in my presentation by clicking on the titles below. Each section also contains bite-sized descriptions of what we achieved in each paper. If you would like to discuss further, you can approach me during the conference, email me at: [vhg23.cam.ac.uk](mailto:vhg23@cam.ac.uk){:target="_blank" rel="noopener"} or connect with me on [LinkedIn](https://www.linkedin.com/in/victor-h-gonz%C3%A1lez-129023a1/){:target="_blank" rel="noopener"}.

## [Spintronic devices as next-generation computation accelerators](https://doi.org/10.1016/j.cossms.2024.101173){:target="_blank" rel="noopener"}
...
## [Voltage control of frequency, effective damping, and threshold current in nano-constriction-based spin Hall nano-oscillators](https://doi.org/10.1063/5.0128786){:target="_blank" rel="noopener"}
...
## [Spin-wave-mediated mutual synchronization and phase tuning in spin Hall nano-oscillators](https://www.nature.com/articles/s41567-024-02728-1){:target="_blank" rel="noopener"}
...
## [A numerical model for time-multiplexed Ising machines based on delay-line oscillators](https://doi.org/10.48550/arXiv.2406.07197){:target="_blank" rel="noopener"}
...
## [A spinwave Ising machine](https://www.nature.com/articles/s42005-023-01348-0#Abs1){:target="_blank" rel="noopener"}
...
## [Global biasing using a hardware-based artificial Zeeman term in spinwave Ising machines](https://doi.org/10.1063/5.0185888){:target="_blank" rel="noopener"}
